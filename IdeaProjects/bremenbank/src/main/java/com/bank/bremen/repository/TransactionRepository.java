...
public interface TransactionRepository extends JpaRepository<Transaction,Long> {
    ...
    List<Transaction> getCustomerTransactions(@Param("id") Long accountId
            ,@Param(value="sDate") LocalDateTime startDate
    ...
    List <Transaction> getBankStatement(@Param (value="sDate") LocalDateTime startDate
                                            ,@Param(value="eDate") LocalDateTime endDate);
